  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-primary": "linear-gradient(135deg, #ffffff 0%, #a8c8f8 40%, #4A90E2 100%)",
        "gradient-dark": "linear-gradient(135deg, #000000 0%, #080810 50%, #0d0d1a 100%)",
        "gradient-glass": "linear-gradient(135deg, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0.03) 100%)",
        "gradient-glow": "radial-gradient(ellipse at center, rgba(74,144,226,0.25) 0%, transparent 70%)",
        "gradient-blob": "radial-gradient(circle at 50% 50%, rgba(74,144,226,0.3) 0%, rgba(168,200,248,0.15) 50%, transparent 70%)",
      },
      boxShadow: {
        glow: "0 0 20px rgba(74,144,226,0.5)",
        "glow-lg": "0 0 40px rgba(74,144,226,0.6), 0 0 80px rgba(74,144,226,0.3)",
        "glow-sm": "0 0 10px rgba(74,144,226,0.4)",
        "glow-cyan": "0 0 20px rgba(74,144,226,0.5)",
