          ...
          >
            ...
            >
              <Link
                ...
                className="px-8 py-4 rounded-xl bg-primary-600 hover:bg-primary-700 text-white font-semibold transition-all shadow-glow hover:shadow-glow-lg hover:scale-105"
              >
                {config.ctaPrimaryLabel}
              </Link>
              <Link
                href={config.ctaSecondaryHref}
                className="px-8 py-4 rounded-xl bg-glass hover:bg-glass-strong border border-border text-white font-semibold transition-all hover:scale-105"
              >
