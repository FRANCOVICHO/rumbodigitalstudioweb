        ...
        {projects.length === 0 ? (
          ...
          >
            <div className="p-12 rounded-2xl bg-background-card border border-border space-y-6">
              <FolderOpen className="w-16 h-16 text-foreground-subtle mx-auto" />
              <div>
                <h3 className="text-xl font-bold mb-2">Portfolio en construcción</h3>
                <p className="text-foreground-muted">
                  Pronto vas a ver acá los proyectos que realizamos. Mientras tanto, contactanos para conocer nuestro trabajo.
                </p>
              </div>
              <a
                href="#contacto"
